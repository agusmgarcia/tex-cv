...
\homepage{https://agustin-garcia.web.app/}                         % optional, remove / comment the
%line if not wanted
...
\section{Projects}
\cventry{2023}{DetailingCarW}{Web}{React}{}{Personal development of a USA based comapany's web page. It contains information about different cars washing services. It also allows administrators to create, edit and delete these services. The web page has been built using React, NextJS and Firebase.
\href{http://detailingcarw.com/}{http://detailingcarw.com/}}

\cventry{2023}{SWR}{Web}{React}{}{Personal development of a React library that handles application global state efficiently and avoiding multiple re-renders. It is object oriented and it is also similar to Zustand. The library has been built using React.
\href{https://github.com/agusmgarcia/react-swr/}{https://github.com/agusmgarcia/react-swr}}

\cventry{2021}{Monthly Incomes}{Web}{React}{}{Personal development of a software that allows you to record your entry and exit movements grouping them by categories. The information is stored in a non-relational database so it can be consulted in different ways using a series of filters provided. The web page has been built using React, NextJS and Firebase.
\href{https://monthly-incomes.web.app/}{https://monthly-incomes.web.app/}}

\cventry{2021}{Personal Portfolio}{Web}{React}{}{Personal development of my portfolio where all the companies I have worked for are lsited. It also shows all the technologies I use to develop applications. The web page has been built using React, NextJS and Firebase.
\href{https://agustin-garcia.web.app/}{https://agustin-garcia.web.app/}}
